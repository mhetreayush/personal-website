...
const projects_data: ProjectType[] = [
  {
    ...
    tags: ['NextJS', 'TailwindCSS', 'Healthcare', 'Whisper_AI', 'OpenAI_API', 'ReactQuery'],
  },
  {
    name: 'DoGether',
    type: 'Hackathon - Self made',
    description: (
      <>
        <p>
          A platform where women can collaborate and work together on a project. This platform promotes women
          empowerment.
        </p>
        <ul>
          <li>A woman hosts a project.</li>
          <li>Other women with similar interests and skills can join as collaborators.</li>
  ...
  },
  {
    ...
    description: (
      <>
        <p>Research API and AI API based idea generation and project analysis tool.</p>
        <ul>
          <li>A platform where user enters keyword and gets several product ideas based on those keywords.</li>
          <li>The platform also provides problem statement definition, market research, competitor analysis.</li>
          <li>The platform also provides questionnaire which also has a globally-accessible link.</li>
          <li>The link can be shared and responses could be collected.</li>
          <li>The responses could be viewed in the form of pie charts in a dedicated section.</li>
        </ul>
      </>
    ),
    demo: 'https://ignitia-23.vercel.app/',
    sourceCode: 'https://github.com/mhetreayush/ignitia-23',
    tags: ['NextJS', 'Firebase', 'TailwindCSS', 'Dynamic_Routing', 'OpenAI_API', 'ChatGPT', 'Prompts', 'ChartJS'],
  },
  {
    name: 'Google Clone',
    ...
    tags: ['NextJS', 'Google', 'TailwindCSS', 'Dynamic_Routing', 'Google_Custom_Search_API'],
  },
  {
  ...
  },
  {
    ...
    tags: ['NextJS', 'FakerJS', 'TailwindCSS', 'Firebase', 'Dynamic_Routing', 'Recoil_State_Management', 'Next_Auth'],
  },
  {
    ...
    description: (
      <>
        ...
        <ul>
          ...
          <li>Used intersection-observer API for dynamic navbar highlighting.</li>
